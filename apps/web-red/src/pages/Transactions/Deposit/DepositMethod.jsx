...
const DepositMethod = () => {
    ...
    function handleChoose(method) {
        ...
        if (key.includes("namibia") && key.includes("access money")) {
            navigate("/deposit-namibia/access-money-wallet-deposit/get-payment-details");
                                                    ...
                                                    <div className="col-12 col-lg-12">
                                                        <div className="row g-3 justify-content-center">
                                                            {methods.map((m, idx) => {
                                                                ...
                                                                const isEasyWallet = /(?:^|\b)easy[-\s]?wallet\b/.test(
                                                                    nk
                                                                );
                                                                const isBlueWallet = /(?:^|\b)blue[-\s]?wallet\b/.test(
                                                                    nk
                                                                );
                                                                const isEwallet =
                                                                    /\bewallet\b|(?:^|\b)e[-\s]?wallet\b/.test(nk);
                                                                const isNedBank =
                                                                    /\bnedbank \b|(?:^|\b)e[-\s]?wallet\b/.test(nk);
                                                                const isAccessMoney =
                                                                ...
                                                                if (isManual) {
                                                                    perCardHistoryRoute =
                                                                        tx.manual_deposit_history ?? tx.depositHistory;
                                                                    ...
                                                                    perCardHistoryRoute =
                                                                        tx.ewallet_deposit_history ?? tx.depositHistory;
                                                                } else if (isNedBank) {
                                                                    perCardHistoryRoute =
                                                                        tx.nedbank_wallet_history ?? tx.depositHistory;
                                                                    ...
                                                                    perCardHistoryRoute =
                                                                        tx.kazang_deposit_history ?? tx.depositHistory;
                                                                } else {

...
import {sendDepositRequestNamibiaAccessMoneyWallet} from "@core/api/depositAPI";
...
// import {APP_NAME, CURRENCY_SYMBOL} from "@repo/frontend-core";
                    ...
                    <div className="modal-dialog modal-dialog-centered modal-sm justify-content-center">
                        <div className="modal-content" style={{width: "220px"}}>
                            <div className="modal-body d-flex flex-column align-items-center">
                                <img src="/assets/img/icons/coin.png" className="mb-2 w-75 coin-animate" alt="rupee" />

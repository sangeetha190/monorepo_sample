...
const routes = {
    ...
    transactions: {
        ...
        manual_withdraw_India: "/manual-withdraw-india",
        manual_withdraw_Namibia_history: "/withdraw-namibia/manual-withdraw/history",

        // easy-wallet
        easy_wallet_deposit: "/deposit-namibia/easy-wallet-deposit/get-payment-details",
        easy_wallet_history: "/deposit-namibia-easy-wallet-history",

        // blue-wallet
        blue_wallet_deposit: "/deposit-namibia/blue-wallet-deposit/get-payment-details",
        blue_wallet_history: "/deposit-namibia/blue-wallet-history",

        // nedBank-wallet
        nedbank_wallet_deposit: "/deposit-namibia/nedbank-wallet-deposit/get-payment-details",
        nedbank_wallet_history: "/deposit-namibia/nedbank-wallet-history",

        // Access-wallet
        access_money_wallet_deposit: "/deposit-namibia/access-money-wallet-deposit/get-payment-details",

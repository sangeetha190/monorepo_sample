...
import {fetchDiceGames, fetchProviderList, fetchSmartSoftGames} from "@core/hooks/homePageApi";
...
function Home() {
    ...
    const {data: diceGames = [], isLoadingDiceGame} = useQuery({
        queryKey: ["diceGames"],
                                                ...
                                                <div className="position-relative my-2">
                                                    ...
                                                    {isLoadingBanner ? (
                                                        ...
                                                        >
                                                            ...
                                                            <SwiperSlide>
                                                                <a
                                                                    href={`https://wa.me/264816633437?text=${encodeURIComponent(
                                                                ...
                                                                >
                                                                    <img
                                                                        src="assets/img/slider/banner_01.png"
                                                                        className="w-100 rounded-2"
                                                                        alt="Gaming Banner Slide 5"
                                                                    />
                                                                </a>
                                                            ...
                                                            <SwiperSlide>
                                                                ...
                                                                >
                                                                    <img
                                                                        src="assets/img/slider/banner_02.png"
                                                                        className="w-100 rounded-2"
                                                                        alt="Gaming Banner Slide 5"
                                                                    />
                                                                </a>
                                                            ...
                                                            <SwiperSlide
                                                                onClick={() => navigate(`/filtered-games?search=slots`)}
                                                            >
                                                                <img
                                                            ...
                                                            <SwiperSlide
                                                                onClick={() => navigate(`/filtered-games?search=lucky`)}
                                                            >
                                                                <img
                                                            ...
                                                            <SwiperSlide
                                                                onClick={() => navigate(`/filtered-games?search=bingo`)}
                                                            >
                                                                <img
                                                            ...
                                                            <SwiperSlide
                                                                onClick={() => navigate(`/filtered-games?search=card`)}
                                                            >
                                                                <img
                                                                    src="assets/img/slider/MINES.png"
                                                                    className="w-100 rounded-2"
                                                                    alt="Gaming Banner Slide 6"
                                                                />
                                                            </SwiperSlide>
                                ...
                                />
                                                    ...
                                                    {isLoadingGames ? (
                                                        ...
                                                        <swiper-container
                                                            ...
                                                            breakpoints={{
                                                                ...
                                                                1024: {
                                                                    slidesPerView: 8, // Laptop/Desktop view
                                                                },
                                                            }}
                                                        >
                                  ...
                                  <h5 className="m-0 ms-2 d-flex align-items-center">
                                    Hot Games
                                                        ...
                                                        <div onClick={() => navigate(`/filtered-games?type=hot`)}>
                                                            {/* <Link to="/all-games"> */}
                                                            <span className="text-white fs-13 fw-500 right_heading">
                                                                All <i className="ri-arrow-right-s-line" />
                                                            </span>
                                                    ...
                                                    <div className="top-matches-title d-flex align-items-center justify-content-between   my-3">
                                                        <div className="d-flex">
                                                            <img
                                                                ...
                                                                alt="Games Type Icon"
                                                            />
                                                            <h5 className="m-0 ms-2">Games Types</h5>
                                                        </div>
                                                        {/* <div>
                                            ...
                                            <SkeletonTheme baseColor="#313131" highlightColor="#525252">
                                                ...
                                                <div>
                                                    <div className="top-matches-title d-flex align-items-center justify-content-between my-3">
                                                        ...
                                                        <div onClick={() => navigate(`/filtered-games?type=slots`)}>
                                                            {/* <Link to={routes.games.all}> */}
                                                            <span className="text-white fs-13 fw-500 right_heading">
                                                                All <i className="ri-arrow-right-s-line" />
                                                            </span>
                                                    ...
                                                    >
                                                        {isLoadingSmartSoftGames ? (
                                                            ...
                                                            <div className="d-flex flex-column align-items-center mt-5 w-100">
                                                                <p className="text-white text-center">
                                                                    Error loading slot games: {errorSmartSoft.message}
                                                                </p>
                                                            </div>
                                        ...
                                        {showModal && (
                                            ...
                                            >
                                                <div className="modal-dialog modal-dialog-centered modal-sm justify-content-center voucher_pop_up">
                                                    <div className="modal-content" style={{width: "240px"}}>
                                                                            ...
                                                                            <>
                                                                                <div className="fw-700 fs-13 mb-1 text-white">
                                                                                    ...
                                                                                    <p className="fw-400 fs-14 mb-1 text-white">
                                                                                        Your free bonus has been
                                                                                        credited — start playing and win
                                                                                        big with Betwise Namibia! 💎💰
                                                                                    </p>
                                                                                </div>
                                                                            </>
                                                                        )}

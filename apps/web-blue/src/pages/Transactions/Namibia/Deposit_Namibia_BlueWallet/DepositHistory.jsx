...
// } from "../../../../../API/depositAPI";
import {depositHistoryBlueNamibia} from "@core/api/depositAPI";
...
// import {CURRENCY_SYMBOL} from "@repo/frontend-core";
                ...
                >
                  🔄 Refresh
                                        ...
                                        <div className="d-flex align-items-center justify-content-between position-relative  px-2">
                                            ...
                                            {/* Centered Title */}
                                            <h5 className="m-0 text-white fs-16 text-center">Blue Wallet History</h5>
                                            <div className="d-flex justify-content-between align-items-center px-0">
                                                            ...
                                                            <div className="d-flex justify-content-between">
                                                                ...
                                                                <div className="d-flex  align-items-end flex-column">
                                                                    <h4 className="mb-1 amount-fs-size">
                                                                        {CURRENCY_SYMBOL} {""}
                                                                        {Number(bet?.deposit_amount ?? 0).toFixed(2)}
                                                                    </h4>

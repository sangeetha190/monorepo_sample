...
// import {EditwalletBank, sendWithdrawRequestWallet} from "../../../../API/withdrawAPI";
import {EditwalletBank, sendWithdrawRequestWallet} from "@core/api/withdrawAPI";
// import {verifyToken} from "../../../../API/authAPI";
import {verifyToken} from "@core/api/authAPI";
import {toast, ToastContainer} from "react-toastify";
// import {loadSelectedBank} from "../../../../API/bankSelectionStorage";
import {loadSelectedBank} from "@core/api/bankSelectionStorage";
                ...
                <div className="card-body px-0">
                    ...
                    {(bankDetails || bank) && (
                        <div className="bank-info bg-glass p-3 rounded-4 mt-3">
                            <h5 className="fw-semibold text-success fw-bold mb-2 px-0">Wallet Information</h5>
                            <div className="text-grey small">
                                ...
                                <p className="mb-1">
                                    Phone Number: <strong>{bankDetails?.phone_number || bank?.account_masked}</strong>
                                </p>
                            </div>
                        </div>
                    )}

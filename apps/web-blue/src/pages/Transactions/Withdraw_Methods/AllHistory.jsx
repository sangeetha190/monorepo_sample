...
// import {fetchWithdrawDetails, fetchWithdrawHistory} from "../../../../API/depositAPI";
import {fetchWithdrawDetails, fetchWithdrawHistory} from "@core/api/depositAPI";
...
const DepositHistory = () => {
    ...
    useEffect(() => {
        ...
        if (next <= (data.last_page || 1)) {
            qc.prefetchQuery({
                ...
                queryFn: () => fetchWithdrawHistory({page: next, perPage: ITEMS_PER_PAGE, token}),
                staleTime: 5 * 60 * 1000,
            });
        }
        if (prev >= 1) {
            qc.prefetchQuery({
                ...
                queryFn: () => fetchWithdrawHistory({page: prev, perPage: ITEMS_PER_PAGE, token}),
                staleTime: 5 * 60 * 1000,
            });
        }
    ...
    const prefetchPage = (p) => {
        ...
        qc.prefetchQuery({
            ...
            queryFn: () => fetchWithdrawHistory({page: p, perPage: ITEMS_PER_PAGE, token}),
            staleTime: 5 * 60 * 1000,
        });
    };
    ...
    const prefetchDetails = (id, type) => {
        ...
        qc.prefetchQuery({
            ...
            queryFn: () => fetchWithdrawDetails({id, type, token}),
            staleTime: 5 * 60 * 1000,
        });
    };
                                ...
                                <div className="pt-3 pb-2">
                                    <div className="row px-2">
                                        ...
                                        <div className="d-flex align-items-center justify-content-between position-relative px-2">
                                            ...
                                            <h5 className="m-0 text-white fs-16 text-center">All Withdraw History</h5>
...
function DepositRow({rowKey, bet, token, isOpen, onToggle, prefetchDetails, statusBadge}) {
    ...
    const {
        ...
        queryFn: () => fetchWithdrawDetails({id: bet.id, type: bet.type, token}),
            ...
            >
                ...
                <div className="dh-row__right d-flex align-items-end flex-column">
                    <div className="dh-amount">
                        {CURRENCY_SYMBOL} {Number(bet?.amount || 0).toFixed(2)}
                    </div>
                            ...
                            return (
                                <div className="dh-grid">
                                    ...
                                    {d.image_url ? (
                                        ...
                                        <>
                                            <p className="text-grey">No Details Found.</p>
                                        </>
                                    )}
